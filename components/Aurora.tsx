...
export default function Aurora(props: any) {
    const { colorStops = ['#000000', '#007AFF', '#2176FF'], amplitude = 1.0, blend = 0.5 } = props;
    ...
    return <div ref={ctnDom} className="w-full h-full absolute inset-0 z-0 pointer-events-none opacity-30 mix-blend-screen" />;
}
